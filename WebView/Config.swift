...
static let loadingSigncolor = #colorLiteral(red: 0.2549019754, green: 0.2745098174, blue: 0.3019607961, alpha: 1) //Set a color for the loading sign indicator
...
static var zipfilename = "download" //The internal file name of the .zip file on the user device (recommended to not change)
...
static let useTimedAds = false //Use timed ads for Facebook Ads (e.g., every 60s) as opposed to ads every X clicks
